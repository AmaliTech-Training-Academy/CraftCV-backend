...
urlpatterns = [
    ...
    path("experiences/<uuid:experience_id>/", ExperienceDetailView.as_view(), name="experience-detail"),
    ...
    path("certifications/<uuid:certification_id>/", CertificationDetailView.as_view(), name="certification-detail"),
    ...
    path("additional-information/", AdditionalInformationListCreateView.as_view(), name="additional-information-list-create"),
    path("additional-information/<uuid:additional_info_id>/", AdditionalInformationDetailView.as_view(), name="additional-information-detail"),
